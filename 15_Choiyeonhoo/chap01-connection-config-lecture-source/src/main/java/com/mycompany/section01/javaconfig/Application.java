package com.mycompany.section01.javaconfig;
...
public class Application {
  ...
  public static void main(String[] args) {
    ...
    * - Mybatis 전체 설정 설정 정보를 담는 객체
    * */

    Configuration configuration = new Configuration(environment);

    /* 3. Mapper 등록
    * - SQL문이 정의된 인터페이스를 Mybatis에 알림
    * */
    ...
    * */
    ...
    /* 5. SqlSession 오픈
    * SqlSession : 실제 DB와 연결되어 상호작용하는 객체 (connection, statement)
    * openSession(false) : 수동 커밋 모드로 Session을 생성*/
    SqlSession sqlSession = sqlSessionFactory.openSession(false);

    /* 6. Mapper 인터페이스 꺼내기
    * - Mybatis가 Mapper 인터페이스를
